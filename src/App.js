...
const Header = () => {
    return (
        ...
        <header
            className="header .d-inline-flex  flex-nowrap header-light bg-light text-dark sticky-top">
            ...
            {/*<Timer/>*/}
            <Modal/>
            <button type="button" className="btn btn-danger order-3 header-endClass" data-bs-toggle="modal"
